...
class Alloy(object):
    ...
    def __getattribute__(self, name):
        ...
        if name in self._parameters: #TODO fix object has no attribute '_parameters'
...
#         return self.name
    ...
    def get_unique_parameters(self):
        ...
        '''
        # start with parameters in the `_parameters` dictionary and cast to list to fix append error on line 160
